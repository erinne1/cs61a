...
def replace_loki_at_leaf(t, lokis_replacement):
    ...
    """
    "*** YOUR CODE HERE ***"
    newCopy = [replace_loki_at_leaf(b, lokis_replacement) for b in branches(t)]
    if label(t)== "loki" and is_leaf(t):
        return tree(lokis_replacement , newCopy)
    else:
        return tree(label(t), newCopy)
...
'''Solutions for dejavu from CS61A'''
